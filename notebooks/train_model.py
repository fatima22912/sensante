...
df.columns = df.columns.str.strip().str.lower()  # Supprimer les espaces dans les noms de colonnes
print(df.columns)
...
X_train, X_test, y_train, y_test = train_test_split(
    ...
    stratify=y          # garder les proportions des classes
)
...
# Encoder les valeurs categorique
